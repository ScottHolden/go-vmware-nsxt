...
type AppDiscoverySessionResultSummary struct {
	...
	AppProfileSummaryList []AppDiscoveryAppProfileResultSummary `json:"app_profile_summary_list,omitempty"`

	// List of app profiles targeted to be classified for this session
	AppProfiles []AppProfileMetaInfo `json:"app_profiles,omitempty"`

	// List of NSGroups provided for discovery for this session
	NsGroups []NsGroupMetaInfo `json:"ns_groups,omitempty"`
}
